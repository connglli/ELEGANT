...
public class PDG_Builder {
    ...
    public static Graph build(CallGraph cg, LabelMaker lm, Chain<soot.SootClass> classes, List<String> excluded) throws InnerBuilder.Error {
    ...
    void build_PDG() throws InnerBuilder.Error {
        ...
        for (soot.SootClass c : allowed) {
            ...
            for (soot.SootMethod m : c.getMethods()) {
                String name = InnerBuilder.method_name(m);
    ...
    void process_class(Map<String,Integer> method_entries, soot.SootClass c) throws InnerBuilder.Error {
        ...
        for (soot.SootMethod m : c.getMethods()) {
            ...
            try {
                InnerBuilder.build(cg, method_entries, lm, g, c, m, body, ebg);
            } catch (InnerBuilder.SootError e) {
