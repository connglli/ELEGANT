...
import edu.cwru.jpdg.InnerBuilder;
import edu.cwru.jpdg.graph.Node;

public class OpLabels implements LabelMaker {

    public void postLabel(InnerBuilder pDG, int uid, Block b) {
    ...
    public String label(InnerBuilder pDG, Block b) {
    ...
    public String label(InnerBuilder pDG, soot.Unit u) {
    ...
    public String label(InnerBuilder pDG, soot.Value left, soot.Value right) {
    ...
    public String label(InnerBuilder pDG, soot.Value value) {
    ...
    public void add_constants(InnerBuilder pDG, int uid, soot.Unit u) {
    ...
    public void add_constant(InnerBuilder pDG, int container_uid, soot.Unit container, soot.jimple.Constant c) {
