...
public class InnerBuilder {
    ...
    public static void build(CallGraph cg, Map<String,Integer> method_entries, LabelMaker lm, Graph g, soot.SootClass c, soot.SootMethod m, soot.Body body, BlockGraph cfg) throws Error {
        InnerBuilder self = new InnerBuilder(cg, method_entries, lm, g, c, m, body, cfg);
        self.build_pDG();
    }

    static InnerBuilder test_instance() {
        return new InnerBuilder();
    }

    private InnerBuilder() {}

    private InnerBuilder(CallGraph cg, Map<String,Integer> method_entries, LabelMaker lm, Graph g, soot.SootClass c, soot.SootMethod m, soot.Body body, BlockGraph cfg) throws Error {
        this.cg = cg;
